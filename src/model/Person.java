 ...
 *
 * As the attribute are set to final (imutable)
 * we will need the constructors to set each attribute
 */
public abstract class Person {

    private final String  id;                                          // good practice is keeping the infos private
    ...
    // Getters and Setters (cos you don't have direct access to the properties)
    public String getId() {
        return id;
    }
